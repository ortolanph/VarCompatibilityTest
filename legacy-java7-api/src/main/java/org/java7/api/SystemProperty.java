...
public enum SystemProperty {
    ...
    JAVA_VM_SPECIFICATION_VENDOR("java.vm.specification.vendor", PropertyCategory.VM, "Java Virtual Machine specification vendor"),
    JAVA_VM_SPECIFICATION_NAME("java.vm.specification.name", PropertyCategory.VM, "Java Virtual Machine specification name"),
    ...
    JAVA_SPECIFICATION_VERSION("java.specification.version", PropertyCategory.SPECIFICATION, "Java Runtime Environment specification version"),
    JAVA_SPECIFICATION_VENDOR("java.specification.vendor", PropertyCategory.SPECIFICATION, "Java Runtime Environment specification vendor"),
    JAVA_SPECIFICATION_NAME("java.specification.name", PropertyCategory.SPECIFICATION, "Java Runtime Environment specification name"),
    ...
    public static void printPropertyReport() {
        for (PropertyCategory category : PropertyCategory.values()) {
            List<SystemProperty> properties = byCategory(category);
